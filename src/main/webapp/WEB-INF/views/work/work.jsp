    ...
    $(document).ready(function(){
    	...
    	function renderingPage(pageTotal,page){
     	...
     	$("#work_table>tbody").on("click","tr",function(e){
     		...
     		if(confirm("상제조회 하시겠습니까?")==false)return;
		...
		<div class="row text-right">
			<form action="#" class="form-inline col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="form-group">
					...
					<input type="button" class="btn btn-default btn-sm" value="검색" id="doRetrive">
					<input type="button" class="btn btn-default btn-sm" value="등록" id="moveToReg">
					<input type="button" class="btn btn-default btn-sm" value="신고" id="doReport">
				</div>
			</form>
		</div>
